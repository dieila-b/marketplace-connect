...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Achetez et vendez près de chez vous : téléphones, véhicules, immobilier, mode et plus." },
      { property: "og:title", content: "Kafoo — Petites annonces" },
      { property: "og:description", content: "Achetez et vendez près de chez vous en Guinée." },
